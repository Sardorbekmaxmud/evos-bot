...
def send_main_menu(context, chat_id, lang_id, message_id=None):
    buttons = [
        ...
        [KeyboardButton(text=globals.BTN_COMMENT[lang_id]), KeyboardButton(text=globals.BTN_CONTACT_US[lang_id])],
        [KeyboardButton(text=globals.BTN_SETTINGS[lang_id])]
    ]

    if message_id:
        context.bot.edit_message_text(
            text="<i><b>" + globals.TEXT_MAIN_MENU[lang_id] + "</b></i>",
            chat_id=chat_id,
